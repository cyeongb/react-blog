let mongoose,bcrypt;_446‍.x([["default",()=>_446‍.o]]);_446‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_446‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);
...
UserSchema.methods.setPassword = async function (password) {
  ...
  _446‍.g.console.log('setPassword 에 들고온 비번 >>', password);

  const hash = await bcrypt.hash(password, 10);
  _446‍.g.console.log('hash 로 만든 비번 >>', hash);
...
UserSchema.methods.checkPassword = async function (password) {
  ...
  _446‍.g.console.log('checkPassword 에 들고온 비번 >>', password);
  const result = await bcrypt.compare(password, this.hashedPassword);
  _446‍.g.console.log('hash 된 비번과 password 비교한 결과 >> ', result);
  return result;
};
...
UserSchema.methods.findByUsername = function (username) {
  ...
  _446‍.g.console.log('findByUsername 에 들고온 username >>', username);
