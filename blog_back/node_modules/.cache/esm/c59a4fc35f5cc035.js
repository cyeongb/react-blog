let Post,mongoose,Joi;_5f5‍.x([["checkObjectId",()=>checkObjectId],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_5f5‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_5f5‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_5f5‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
...
// 일일이 코드를 중복해 넣지 않고 '미들웨어' 로 만들어서 여러 라우트에 쉽게 적용할 수 있다.
  ...
  const { id } = ctx.params;
  _5f5‍.g.console.log('id >> ', id);

  if (!ObjectId.isValid(id)) {
    _5f5‍.g.console.log('id가 검증된 아이디인가? >>', ObjectId.isValid(id));
...
// title:''/body:''/tags:['','']
  ...
  try {
    ...
    _5f5‍.g.console.log('title>>', title);
    ...
    _5f5‍.g.console.log('posts.ctrl.js - write error >>', e);
...
// -------------------------------------- LIST
  ...
  _5f5‍.g.console.log('page >>', page);
  if (page < 1) {
    ctx.status = 400;
    _5f5‍.g.console.log('페이지 없음 >>', ctx.status);
    return;
  }
  try {
    ...
    _5f5‍.g.console.log('list 에 posts >>', posts);

    const postCount = await Post.countDocuments().exec();
    ctx.set('Last_page', Math.ceil(postCount / 10)); //math.ceit : 소수점 이하를 올림한다.

    _5f5‍.g.console.log('post 갯수>>', postCount);
    ...
    _5f5‍.g.console.log('posts.ctrl.js - list error >>', e);
    ctx.throw(500, e);
  }
};
...
// ---------------------------------------- READ
  ...
  try {
    ...
    _5f5‍.g.console.log('read에 post >>', post);

    if (!post) {
      console.log('read -->post 없음');

      ctx.status = 404; //not found
      _5f5‍.g.console.log('ctx.status >>', ctx.status);

      return;
    }
  } catch (e) {
    _5f5‍.g.console.log('posts.ctrl.js - read error >>', e);
    ctx.throw(500, e);
  }
};
...
// ---------------------------------------- REMOVE
  ...
  try {
    ...
    _5f5‍.g.console.log('posts.ctrl.js - remove error >>', e);
    ctx.throw(500, e);
  }
};
...
// ------------------------------------------ UPDATE
  ...
  const result = Joi.validate(ctx.request.body, schema);
  if (result.error) {
    _5f5‍.g.console.log('400 에러 ! >>', result.error);
  ...
  try {
    ...
    _5f5‍.g.console.log('id >>', id);
    _5f5‍.g.console.log('schema >>', schema);
    _5f5‍.g.console.log('result >>', result);
    ...
    ctx.body = post;
    _5f5‍.g.console.log('post>>', post);
  } catch (e) {
    _5f5‍.g.console.log('posts.ctrl.js - update error >>', e);
    ctx.throw(500, e);
  }
};
