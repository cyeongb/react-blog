let mongoose,Schema,bcrypt,jwt;_386‍.x([["default",()=>_386‍.o]]);_386‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}],["Schema",["Schema"],function(v){Schema=v}]]);_386‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_386‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
UserSchema.methods.setPassword = async function (password) {
  ...
  _386‍.g.console.log('setPassword 에 들고온 비번 >>', password);

  const hash = await bcrypt.hash(password, 10);
  _386‍.g.console.log('hash 로 만든 비번 >>', hash);
...
UserSchema.methods.checkPassword = async function (password) {
  ...
  _386‍.g.console.log('checkPassword 에 들고온 비번 >>', password);
  const result = await bcrypt.compare(password, this.hashedPassword);
  _386‍.g.console.log('hash 된 비번과 password 비교한 결과 >> ', result);
  return result;
};
...
UserSchema.methods.findByUsername = function (username) {
  ...
  _386‍.g.console.log('findByUsername 에 들고온 username >>', username);
